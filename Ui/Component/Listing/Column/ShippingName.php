...
class ShippingName extends \Magento\Ui\Component\Listing\Columns\Column
{
    /**
    ...
    public function getQuoteAddress($id)
    {
        ...
        $name = $connection->fetchRow("SELECT firstname, lastname FROM quote_address WHERE quote_id = $id AND address_type = 'shipping'");
